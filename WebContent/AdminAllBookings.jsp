...
%>
       ...
       <div class="collapse navbar-collapse" id="navbarToggler">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item active" href="AdminAllBookings.jsp">All Bookings</a>
...
<table class="adminallbookingtabl js-serial" align="center" cellpadding="5" cellspacing="5" border="1">
...
<%
  ...
  resultSet = statement.executeQuery   ("SELECT * FROM travel ");

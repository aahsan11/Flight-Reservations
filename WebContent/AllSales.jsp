...
%>
   ...
   <header>
       ...
       <div class="collapse navbar-collapse" id="navbarToggler">
            ...
            href="#">Sale</a>
            <div class="dropdown-menu">
              <a class="dropdown-item active" href="AllSales.jsp">All Sales</a>
...
%>  
    ...
    <script>  
        <%  
           ...
           // --- Loop 10 times and create 10 string dates and 10 users  
            ...
            LocalDate end = LocalDate.now().minusMonths(12);
 ...
 resultSets = statement.executeQuery   (" SELECT SUM(Paid) FROM travel  GROUP BY YEAR(DepDate)");
...
e.printStackTrace();
 ...
 resultSet = statement.executeQuery   (" SELECT DISTINCT  YEAR(DepDate) FROM travel  ORDER BY DepDate ASC");

       ...
       <div class="collapse navbar-collapse" id="navbarToggler">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item " href="MonthlySale.jsp">Monthly Sale</a>
                <a class="dropdown-item active" href="PendingSale.jsp">Pending Sale</a>
...
e.printStackTrace();
 ...
 resultSet = statement.executeQuery   (" SELECT DISTINCT MONTHNAME(DepDate) FROM travel WHERE DepDate >= '" + begin + "' AND DepDate <= '" + end + "'" + "ORDER BY DepDate ASC");

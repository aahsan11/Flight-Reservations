      ...
      <header>
       ...
       <div class="collapse navbar-collapse" id="navbarToggler">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item active" href="PreviousBookings.jsp">Previous Bookings</a>
...
<%
  ...
  resultSet = statement.executeQuery   ("SELECT * FROM travel WHERE DepDate < curdate() AND ids=" + "'" + ids + "'");

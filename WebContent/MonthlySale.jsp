   ...
   <header>
       ...
       <div class="collapse navbar-collapse" id="navbarToggler">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item active" href="MonthlySale.jsp">Monthly Sale</a>
                <a class="dropdown-item " href="PendingSale.jsp">Pending Sale</a>
				    <a class="dropdown-item " href="YearlySale.jsp">Quarterly Sale</a>	             
...
%>  
    ...
    <script>  
        <%  
           ...
           // --- Loop 10 times and create 10 string dates and 10 users  
            ...
            LocalDate end = LocalDate.now().minusMonths(11);
  ...
  resultSets = statement.executeQuery (" SELECT SUM(Paid) FROM travel WHERE  DepDate >= '" + end + "' AND DepDate <= '" + begin + "'" + "GROUP BY MONTH(DepDate) ORDER BY DepDate ASC");
...
e.printStackTrace();
 ...
 resultSet = statement.executeQuery   (" SELECT MONTHNAME(DepDate) FROM travel WHERE  DepDate >= '" + end + "' AND DepDate <= '" + begin + "'" + "GROUP BY MONTH(DepDate) ORDER BY DepDate ASC");

       ...
       <div class="collapse navbar-collapse" id="navbarToggler">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item " href="ConfirmBookings.jsp">Confirmed Bookings</a>
                <a class="dropdown-item active" href="PendingBookings.jsp">Pending Bookings</a>
...
<%
  ...
  resultSet = statement.executeQuery   ("SELECT * FROM travel WHERE DepDate >= curdate() AND Status='Pending'");
...
<tr bgcolor="#DEB887">
<td><input type="checkbox" name="selected" value= <%= resultSet.getString("id")%> /> <%= resultSet.getString("id")%></td>
